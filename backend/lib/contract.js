...
// console.log("private key is ", process.env.PRIVATE_KEY_ACCOUNT1);
const account = web3.eth.accounts.wallet.add(process.env.PRIVATE_KEY_ACCOUNT1);

const contractAddress = `0xa1F765C330bFA63F038fdaE9Ce578b46549f7a79`;

// const abi = JSON.parse(process.env.CHARITY_ABI_CODE);
const abi = [
  {
    "inputs": [],
...
export { getBlockNumber, getBalance, sendEth, getOwnerFronContract };
